        ...
        <div class="container">
            ...
            <div class="latent-redesign">
                ...
                <div class="latent-col-right">
                    ...
                    <div class="info-card-clean">
                        <h4>Effectiveness</h4>
                        <p>Results can be compared across glass, plastic, metal, and paper surfaces.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bento-grid">
                <div class="bento-card card-large">
                    <div class="bento-card-content">
                        ...
                        <p id="bento-desc-1">Natural calcium carbonate breaks down safely without environmental harm</p>
                    </div>
                </div>
                ...
                <div class="bento-card card-stacked-1">
                    <div class="bento-card-content">
                        ...
                        <p id="bento-desc-2">Utilizes waste material, reducing production costs significantly</p>
                    </div>
                </div>
                ...
                <div class="bento-card card-stacked-2">
                    <div class="bento-card-content">
                        ...
                        <p id="bento-desc-3">Non-toxic composition eliminates health risks from heavy metals</p>
                    </div>
                </div>
                ...
                <div class="bento-card card-bottom-1">
                    <div class="bento-card-content">
                        ...
                        <p id="bento-desc-4">Transforms food industry waste into valuable forensic resource</p>
                    </div>
                </div>
                ...
                <div class="bento-card card-bottom-2">
                    <div class="bento-card-content">
                        ...
                        <p id="bento-desc-5">Ideal for educational institutions and student practice</p>
                    </div>
                </div>
                ...
                <div class="bento-card card-dark-green card-bottom-3">
                    <div class="bento-card-content">
                        ...
                        <p id="bento-desc-6">Aligns with sustainable consumption and climate action goals</p>
                    </div>
                </div>
            </div>
        </div>
