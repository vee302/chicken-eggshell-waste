            ...
            <div class="sidebar-user">
                <div class="user-info">
                    ...
                    <div class="user-details">
                        <h4><?= htmlspecialchars($faculty_name) ?></h4><span>Faculty Researcher</span>
                    </div>
                </div>
            </div>
            <ul class="sidebar-menu">
                <li class="menu-item"><a href="faculty_dashboard.php" class="menu-link"><svg viewBox="0 0 24 24"
                ...
                <li class="menu-item"><a href="comparison_dashboard.php" class="menu-link"><svg viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                            <line x1="18" y1="20" x2="18" y2="10" />
                            <line x1="12" y1="20" x2="12" y2="4" />
                            <line x1="6" y1="20" x2="6" y2="14" />
                        </svg><span>Comparison Dashboard</span></a></li>
                <li class="menu-item"><a href="validate_accuracy.php" class="menu-link"><svg viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                            <polyline points="9 11 12 14 22 4" />
                            <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" />
                        </svg><span>Validate Accuracy Scores</span></a></li>
                <li class="menu-item"><a href="surface_performance.php" class="menu-link"><svg viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                            <path d="M21.21 15.89A10 10 0 1 1 8 2.83" />
                            <path d="M22 12A10 10 0 0 0 12 2v10z" />
                        </svg><span>Surface Performance</span></a></li>
                <li class="menu-item"><a href="safety_climate_log.php" class="menu-link"><svg viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                ...
                <li class="menu-item active"><a href="student_records.php" class="menu-link"><svg viewBox="0 0 24 24"
                        ...
                        </svg><span>View Student Records</span></a></li>
                <li class="menu-item"><a href="generate_reports.php" class="menu-link"><svg viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                            <polyline points="14 2 14 8 20 8" />
                        </svg><span>Generate Reports</span></a></li>
            </ul>
            <div class="sidebar-footer"><a href="../logout.php" class="menu-link" style="color:#e07a5f;"><svg
        ...
        <main class="admin-main">
            <header class="admin-header">
                <div class="header-left">
                    <button class="menu-toggle" id="sidebarCollapse"><svg viewBox="0 0 24 24" width="24" height="24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                    ...
                    <div class="header-title">
                        <h2>Green Forensics — Student Records</h2>
                    </div>
                </div>
            </header>
            ...
            <div class="admin-content">
                ...
                <form method="GET" class="search-filter-bar">
                    <div class="bar-left">
                        <input type="text" name="search" value="<?= htmlspecialchars($search) ?>"
                            placeholder="Search by student name..." class="form-control-inline" style="width:240px;">
                        <select name="powder" class="form-control-inline">
                            <option value="">All Powder Types</option>
                            <option value="eggshell" <?= $f_pwd === 'eggshell' ? 'selected' : '' ?>>Eggshell-Based Powder
                            </option>
                            <option value="commercial" <?= $f_pwd === 'commercial' ? 'selected' : '' ?>>Commercial Powder
                            </option>
                        </select>
                        ...
                        <select name="status" class="form-control-inline">
                            ...
                            <option value="pending_validation" <?= $f_stat === 'pending_validation' ? 'selected' : '' ?>>
                            ...
                            <option value="needs_revision" <?= $f_stat === 'needs_revision' ? 'selected' : '' ?>>Needs
                                Revision</option>
                        </select>
                    </div>
                    <div class="bar-right">
                ...
                <div class="dashboard-card">
                    <div class="card-title-wrap">
                        <h3>Submissions Found: <?= count($rows) ?></h3>
                    </div>
                    <div class="table-responsive">
                        <table class="custom-table">
                            ...
                            <tbody>
                                <?php if (empty($rows)): ?>
                                    <tr>
                                        <td colspan="10" style="text-align:center;padding:2rem;color:#6c757d;">No records
                                            found.</td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($rows as $r): ?>
                                        <tr>
                                            ...
                                            <td style="font-size:.82rem;color:#6c757d;max-width:180px;">
                                                <?= $r['faculty_remarks'] ? htmlspecialchars($r['faculty_remarks']) : '<em>No remarks yet</em>' ?>
                                            </td>
                                            <td style="text-align: center;">
                                                <a href="student_records.php?view=<?= $r['id'] ?><?= $search ? '&search=' . urlencode($search) : '' ?><?= $f_pwd ? '&powder=' . urlencode($f_pwd) : '' ?><?= $f_surf ? '&surface=' . urlencode($f_surf) : '' ?><?= $f_stat ? '&status=' . urlencode($f_stat) : '' ?>"
        ...
        <div class="detail-overlay open" id="recordOverlay">
            <div class="detail-modal">
                <div class="detail-modal-header">
                    <h3>Trial Record Details: ID
                        #<?= htmlspecialchars($view_record['trial_id'] ?: 'TR-' . str_pad($view_record['id'], 4, '0', STR_PAD_LEFT)) ?>
                    </h3>
                    <button class="modal-close-btn"
                        onclick="document.getElementById('recordOverlay').classList.remove('open')">&times;</button>
                </div>
                <div class="detail-modal-body">
                    <p class="section-divider">Forensic Submission Details</p>
                    <div class="detail-row"><span class="detail-label">Student Submitter</span><span
                            class="detail-value"><?= htmlspecialchars($view_record['student_name']) ?></span></div>
                    <div class="detail-row"><span class="detail-label">Powder Type Used</span><span class="detail-value"
                            style="text-transform: capitalize; font-weight: 600;"><?= htmlspecialchars($view_record['powder_type']) ?></span>
                    </div>
                    <div class="detail-row"><span class="detail-label">Surface Material Type</span><span
                            class="detail-value"
                            style="text-transform: capitalize; font-weight: 600;"><?= htmlspecialchars($view_record['surface_type']) ?></span>
                    </div>
                    <div class="detail-row"><span class="detail-label">Image Label</span><span
                            class="detail-value"><?= htmlspecialchars($view_record['image_label'] ?: 'Untitled') ?></span>
                    </div>
                    <div class="detail-row"><span class="detail-label">Notes from Submission</span><span
                            class="detail-value"><?= nl2br(htmlspecialchars($view_record['notes'] ?: 'No notes provided.')) ?></span>
                    </div>
                    <div class="detail-row"><span class="detail-label">Date Submitted</span><span
                            class="detail-value"><?= date('F d, Y g:i A', strtotime($view_record['submitted_at'])) ?></span>
                    </div>

                    <p class="section-divider">Fingerprint Image Asset</p>
                    <div
                        style="text-align:center; margin-bottom:1rem; border:1px solid #e9ecef; padding:10px; border-radius:8px; background:#fafafa;">
                        <?php if (!empty($view_record['image_path']) && file_exists(dirname(__DIR__) . '/uploads/fingerprints/' . $view_record['image_path'])): ?>
                            <a href="../view_fingerprint.php?test_id=<?= $view_record['id'] ?>" target="_blank">
                                <img src="../view_fingerprint.php?test_id=<?= $view_record['id'] ?>"
                                    style="max-height:220px; max-width:100%; object-fit:contain; border-radius:6px; border:1px solid #ddd;"
                                    alt="Fingerprint Image Asset">
                            </a>
                        <?php else: ?>
                            <div
                                style="padding:2rem; background:#f4f6f0; border-radius:6px; font-weight:600; color:var(--danger);">
                                Image not found</div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="score-box">
                        ...
                        <div class="score-values">
                            <div>
                                <div class="score-val">
                                    <?= $view_record['ridge_clarity_score'] !== null ? number_format($view_record['ridge_clarity_score'], 1) . '%' : '—' ?>
                                </div>
                                <div class="score-lbl">Clarity</div>
                            </div>
                            <div>
                                <div class="score-val">
                                    <?= $view_record['visibility_score'] !== null ? number_format($view_record['visibility_score'], 1) . '%' : '—' ?>
                                </div>
                                <div class="score-lbl">Visibility</div>
                            </div>
                            <div>
                                <div class="score-val">
                                    <?= $view_record['adhesion_score'] !== null ? number_format($view_record['adhesion_score'], 1) . '%' : '—' ?>
                                </div>
                                <div class="score-lbl">Adhesion</div>
                            </div>
                            <div>
                                <div class="score-val">
                                    <?= $view_record['contrast_score'] !== null ? number_format($view_record['contrast_score'], 1) . '%' : '—' ?>
                                </div>
                    ...
                    <div class="detail-row"
                        style="background: var(--cream); padding: 8px 12px; border-radius: 6px; border-left: 4px solid var(--medium-green);">
                        <span class="detail-label" style="font-weight: 700;">Faculty Final Score</span>
                        <span class="detail-value"
                            style="font-weight: 800; color: var(--dark-green); font-size:1.1rem;"><?= $view_record['faculty_final_score'] !== null ? number_format($view_record['faculty_final_score'], 1) . '%' : ($view_record['status'] === 'pending_validation' ? 'Awaiting Validation' : '—') ?></span>
                    </div>
                    ...
                    <div class="detail-row"><span class="detail-label">Faculty Reviewer</span><span class="detail-value"
                            style="font-weight: 600;"><?= htmlspecialchars($view_record['validator_name'] ?: 'Awaiting Review') ?></span>
                    </div>
                    <div class="detail-row"><span class="detail-label">Review Date</span><span
                            class="detail-value"><?= $view_record['validation_date'] ? date('F d, Y g:i A', strtotime($view_record['validation_date'])) : '—' ?></span>
                    </div>
                    <div class="detail-row"><span class="detail-label">Remarks from Reviewer</span><span
                            class="detail-value"
                            style="font-style: italic;"><?= nl2br(htmlspecialchars($view_record['faculty_remarks'] ?: 'No evaluation remarks submitted yet.')) ?></span>
                    </div>
                </div>
            </div>
        </div>
