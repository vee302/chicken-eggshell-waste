...
<head>
    ...
    <style>
        ...
        .stat-card.pending-card::after {
            background: #f4a261;
        }

        .stat-card.approved-card::after {
            background: #52b788;
        }

        .stat-card.rejected-card::after {
            background: #e07a5f;
        }
        ...
        .btn-approve-workspace:hover:not(:disabled) {
            background: #1b4332;
            transform: translateY(-1px);
        }

        .btn-reject-workspace {
            background: #e07a5f;
            box-shadow: 0 4px 12px rgba(224, 122, 95, 0.15);
        }

        .btn-reject-workspace:hover:not(:disabled) {
            background: #c0392b;
            transform: translateY(-1px);
        }

        .btn-revision-workspace {
            background: #f4a261;
            box-shadow: 0 4px 12px rgba(244, 162, 97, 0.15);
        }

        .btn-revision-workspace:hover:not(:disabled) {
            background: #e76f51;
            transform: translateY(-1px);
        }
    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="menu-item active"><a href="validate_accuracy.php" class="menu-link"><svg viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                ...
                <li class="menu-item"><a href="student_records.php" class="menu-link"><svg viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
            ...
            <header class="admin-header">
                <div class="header-left">
                    ...
                    <div class="header-title">
                        <h2>Green Forensics — Validate Accuracy Scores</h2>
                    </div>
                </div>
            </header>
            ...
            <div class="admin-content">
                <div class="page-header-wrap">
                    <div class="page-title">
                        ...
                        <p>Review student fingerprint trial submissions, verify quality metrics, and input final
                            decisions.</p>
                    </div>
                </div>
                ...
                <div class="stats-grid" style="margin-bottom: 1.5rem;">
                    <div class="stat-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-icon"><svg viewBox="0 0 24 24" width="20" height="20" fill="none"
                    ...
                    <div class="stat-card pending-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-icon" style="background:rgba(244,162,97,.12);color:#c97d2a;"><svg
                    ...
                    <div class="stat-card approved-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-icon" style="background:rgba(82,183,136,.12);color:#2d6a4f;"><svg
                                    viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor"
                                    stroke-width="2.5">
                    ...
                    <div class="stat-card rejected-card">
                        <div class="stat-header">
                            ...
                            <div class="stat-icon" style="background:rgba(224,122,95,.12);color:#c0392b;"><svg
                                    viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor"
                                    stroke-width="2.5">
                ...
                <div class="validate-workspace-grid">
                    ...
                    <div class="workspace-sidebar-card">
                        ...
                        <div class="search-box-container">
                            <input type="text" id="trialSearch" placeholder="Search student or trial ID..."
