<?php
// student/ajax_submit_trial.php — Student AJAX Submit Trial Data with Image Evaluation
...
if (move_uploaded_file($file['tmp_name'], $dest)) {
    ...
    try {
        ...
        // Insert trial record (scores may be numeric or NULL)
        $stmt = $pdo->prepare("
            INSERT INTO fingerprint_tests 
                (trial_id, student_id, image_path, image_label, powder_type, surface_type, 
                 ...
                 notes, status, submitted_at, ai_evaluated_at, evaluation_source, ai_accuracy_score)
        ...
        $stmt->execute([
            ...
            $notes, $ai_evaluated_at, $evaluation_source, $ai_accuracy
        ]);
