...
try {
    ...
    foreach ($images as &$img) {
        ...
        if (!empty($img['image_path'])) {
            ...
            if (file_exists($filePath) || !empty($img['gdrive_file_id']) || !empty($img['image_path'])) {
            ...
            <div class="student-content">
                ...
                <div class="evaluation-preview-wrapper">
                    <div class="dashboard-card evaluation-preview-card">
                        <form id="form-upload-fingerprint">
                            <input type="hidden" id="submission_token" name="submission_token"
                                value="<?php echo htmlspecialchars($_SESSION['submit_token']); ?>">
                            <!-- Camera-Based Evaluation Preview Panel -->
                            <div class="camera-preview-panel"
                                style="background: #fff; text-align: center; margin-bottom: 1.5rem;">


                                <!-- Title & Subtitle -->
                                <h2
                                    style="font-size: 1.5rem; font-weight: 800; color: #1e392a; margin: 0 0 8px 0; font-family: 'Inter', system-ui, sans-serif;">
                                    Camera-Based Evaluation Preview</h2>
                                <p style="font-size: 0.88rem; color: #5f6368; margin: 0 0 1.5rem 0;">Visual preview of
                                    the secured student dashboard feature.</p>

                                <!-- Dashed Box Container (Visual Area) -->
                                <div id="previewContainer"
                                    style="border: 2px dashed #c3d9c3; border-radius: 12px; padding: 2.5rem 2rem; background: #fafdfa; min-height: 220px; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; margin-bottom: 1.5rem; transition: all 0.3s ease;">

                                    <!-- Captured or Uploaded Image Preview (Hidden initially) -->
                                    <img id="webcamCapturePreview"
                                        style="display: none; width: 100%; max-height: 250px; object-fit: contain; border-radius: 8px;"
                                        alt="Preview Image">

                                    <!-- Idle Placeholder (Shown initially) -->
                                    <div id="previewPlaceholder"
                                        style="text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; color: #6e8c78;">
                                        ...
                                        <h4
                                            style="font-size: 1.1rem; font-weight: 700; color: #2d4c38; margin: 0 0 6px 0;">
                                            Camera Preview / Uploaded Image</h4>
                                        <p style="font-size: 0.82rem; color: #88a68f; margin: 0; font-weight: 600;">
                                            Preview Mode Only</p>
                                    </div>
                                </div>
                                ...
                                <div class="camera-button-grid no-print">
                                    ...
                                    <button type="button" class="btn" id="btnStartWebcam"
                                        style="background: #e2ebe4; border: 1px solid #ccdcd0; color: #1b4332; font-weight: 700; font-size: 0.82rem; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 0.75rem 1rem; border-radius: 8px; cursor: pointer; transition: all 0.2s ease; text-transform: uppercase; letter-spacing: 0.03em;">
                                        <svg viewBox="0 0 24 24" width="15" height="15" fill="none"
                                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                                            stroke-linejoin="round" style="color: #1b4332;">
                                            <path
                                                d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" />
                                            <circle cx="12" cy="13" r="4" />
                                        </svg>
                                    ...
                                    <!-- Upload File Button -->
                                    <button type="button" class="btn" id="btnUploadTrigger"
                                        style="background: #fff; border: 1px solid #ccdcd0; color: #2d4c38; font-weight: 700; font-size: 0.82rem; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 0.75rem 1rem; border-radius: 8px; cursor: pointer; transition: all 0.2s ease; text-transform: uppercase; letter-spacing: 0.03em;">
                                        <svg viewBox="0 0 24 24" width="15" height="15" fill="none"
                                            stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                                            stroke-linejoin="round" style="color: #2d4c38;">
                                ...
                                <div id="file-chosen"
                                    style="font-size: 0.82rem; font-weight: 700; color: #2d6a4f; margin-top: 1rem; text-align: center; min-height: 1.2rem;">
                                </div>
                            </div>
                            ...
                            <input type="file" id="fingerprint_camera" accept="image/*" capture="environment"
                                style="display:none;">

                            <div class="form-grid-2" style="margin-top: 1.25rem;">
                                <div class="form-group">
                                    <label for="powder_type">Powder Type <span
                                ...
                                <div class="form-group">
                                    <label for="surface_type">Surface Type <span
                                            style="color:var(--danger)">*</span></label>
                            ...
                            <div
                                style="margin: 1.5rem 0; padding: 0.95rem 1.1rem; background: #f4f6f0; border-left: 4px solid var(--medium-green); border-radius: 4px; font-size: 0.78rem; color: #5f6368; line-height: 1.45;">
                                <strong>Disclaimer / Notice:</strong> This feature is for educational and research
                                evaluation only. It is not used for biometric identification. It is only designed for
                                Camera-Based Latent Fingerprint Capture and AI-Assisted Image Quality Evaluation using
                                Chicken Eggshell Waste powder.
                            </div>

                            <button type="submit" class="btn btn-primary" id="btn-upload-image"
                                style="width: 100%; padding: 0.85rem; font-size: 0.95rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; justify-content: center; gap: 8px; background: #224229 !important; border-color: #224229 !important; border-radius: 8px; color: #fff;"
                                disabled>
                ...
                <div class="dashboard-card">
                    <div class="card-title-wrap">
                        ...
                        <span style="font-size:.82rem;color:var(--gray);"><?= count($images) ?>
                            image<?= count($images) !== 1 ? 's' : '' ?></span>
                    </div>
                    <?php if (empty($images)): ?>
                        <p id="noImagesText" style="color:var(--gray);font-size:.88rem;text-align:center;padding:1.5rem 0;">
                        ...
                        <div class="image-gallery">
                            <?php foreach ($images as $img): ?>
                                <div class="image-thumb">
                                    ...
                                    <?php else: ?>
                                        <div
                                            style="height:130px; background:#f4f6f0; display:flex; flex-direction:column; align-items:center; justify-content:center; color:var(--gray); font-size:0.72rem; text-align:center; padding:10px;">
                                            <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                                                style="color:var(--gray); margin-bottom: 6px;">
                                    ...
                                    <div class="image-thumb-info">
                                        ...
                                        <div
                                            ...
                                            <?= htmlspecialchars($img['surface_type']) ?>
                                        </div>
                                        <div class="image-thumb-date" style="font-size:0.68rem;">
                                            <?= date('M d, Y', strtotime($img['submitted_at'])) ?></div>
                                        <div
                                            style="margin-top: 4px; display: flex; align-items: center; justify-content: space-between; gap: 4px;">
                                            <span class="badge badge-<?= $img['status'] ?>"
                                                style="font-size: 0.65rem; padding: 2px 6px; flex-shrink: 0;">
                                        ...
                                        <div style="margin-top: 8px;">
                                            <button type="button" class="btn btn-secondary btn-sm"
                                                onclick='openDetailModal(<?= htmlspecialchars(json_encode($img), ENT_QUOTES, "UTF-8") ?>)'
                                                style="width: 100%; padding: 0.35rem 0.5rem; font-size: 0.72rem; border-radius: 6px; justify-content: center;">View
                                                Details</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <div id="cameraModal" class="camera-modal" style="display: none;">
        ...
        <div class="autocapture-container" style="display: none;">
            ...
            <div class="sensitivity-control">
                ...
                <input type="range" id="rangeSensitivity" class="sensitivity-slider" min="20" max="80" value="50"
                    step="5">
            </div>
        </div>
                ...
                <div id="modalContent">
                    <div class="inspect-grid">
                        ...
                        <div>
                            ...
                            <div style="text-align:center; color: var(--gray); font-weight:600; margin-bottom:1rem; display:none;"
                                id="det-img-missing">
